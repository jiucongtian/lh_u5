...
public class ChatRefreshListView extends ListView implements OnScrollListener {
    ...
    public ChatRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void initHeadView(Context context) {
        mHeadView = LayoutInflater.from(context).inflate(
                R.layout.chat_refresh_head, null);

        mArrowImageView = (ImageView) mHeadView
                .findViewById(R.id.head_arrowImageView);
        mArrowImageView.setMinimumWidth(60);

        mHeadUseGuide = (ImageView) mHeadView.findViewById(R.id.head_use_guide);
...
//		closeAddMoreListener.closeAddMore();
        mySoftInputViewListViewListener.softInputViewListViewHide();
    ...
    private void startUserGuideAnimation() {
        animationDrawable = (AnimationDrawable) mHeadUseGuide.getDrawable();
    ...
    private void stopUserGuideAnimation() {
    ...
    public interface SoftInputViewListViewListener {

        void softInputViewListViewHide();
    }

    private SoftInputViewListViewListener mySoftInputViewListViewListener;

    public void setSoftInputViewListener(
            SoftInputViewListViewListener mySoftInputViewListViewListener) {
        this.mySoftInputViewListViewListener = mySoftInputViewListViewListener;
    }

//	public interface CloseAddMoreListener {
//		void closeAddMore();
//	}
//
//	private CloseAddMoreListener closeAddMoreListener;
//
//	public void setCloseAddMoreListener(
//			CloseAddMoreListener closeAddMoreListener) {
//		this.closeAddMoreListener = closeAddMoreListener;
//	}
